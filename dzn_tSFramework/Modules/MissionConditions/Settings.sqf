...
MissionCondition1 = [ "WIN", {TGT inArea baseTrg && {call fnc_CheckPlayersReturned} }, "All objectives done" ];
MissionCondition2 = [ "FAIL", {!alive TGT && {call fnc_CheckPlayersReturned} }, "MVP is death" ];
